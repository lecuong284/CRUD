		...
		@include('crud::inc.grouped_errors')
		  ...
		  <div class="box">
		    ...
		    <div class="box-header with-border">
		      <h3 class="box-title">{{ trans('lecuong::crud.add_a_new') }} {{ $crud->entity_name }}</h3>
		    </div>
		    <div class="box-body row">
		      <!-- load the view from the application if it exists, otherwise load the one in the package -->
		      @if(view()->exists('vendor.lecuong.crud.form_content'))
		      	@include('vendor.lecuong.crud.form_content', [ 'fields' => $crud->getFields('create'), 'action' => 'create' ])
		      @else
