...
All Notable changes to `Lecuong CRUD` will be documented in this file
...
### Removed
- Lecuong\CRUD no longer loads translations, as Lecuong\Base does it for him.
...
- elFinder iframe now has no white background and uses lecuong theme;
...
- URLs in views now use the lecuong.base.route_prefix; fixes #88;
...
### Removed
- PHP dependency, since it's already settled in Lecuong\Base, which is a requirement;
...
### Added
- Auto-registering the Lecuong\Base class;
- Improved documentation for those who want to just install Lecuong\CRUD;
...
### Fixed
- Crud.php fixes found out during Lecuong\PermissionManager development.
...
### Added
- Added a custom theme for elfinder, called elfinder.lecuong.theme, that gets published with the CRUD public files.
...
### Fixed
- Changed name from Dick/CRUD to Lecuong/CRUD.
