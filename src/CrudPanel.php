...
use Lecuong\CRUD\PanelTraits\Read;
use Lecuong\CRUD\PanelTraits\Tabs;
use Lecuong\CRUD\PanelTraits\Query;
use Lecuong\CRUD\PanelTraits\Views;
use Lecuong\CRUD\PanelTraits\Access;
use Lecuong\CRUD\PanelTraits\Create;
use Lecuong\CRUD\PanelTraits\Delete;
use Lecuong\CRUD\PanelTraits\Errors;
use Lecuong\CRUD\PanelTraits\Fields;
use Lecuong\CRUD\PanelTraits\Update;
use Lecuong\CRUD\PanelTraits\AutoSet;
use Lecuong\CRUD\PanelTraits\Buttons;
use Lecuong\CRUD\PanelTraits\Columns;
use Lecuong\CRUD\PanelTraits\Filters;
use Lecuong\CRUD\PanelTraits\Reorder;
use Lecuong\CRUD\PanelTraits\AutoFocus;
use Lecuong\CRUD\PanelTraits\FakeFields;
use Lecuong\CRUD\PanelTraits\FakeColumns;
use Lecuong\CRUD\PanelTraits\ViewsAndRestoresRevisions;
...
class CrudPanel
{
     ...
     * - $this->crud->setRoute(config('lecuong.base.route_prefix').'/article')
     * - $this->crud->setRouteName(config('lecuong.base.route_prefix').'.article')
     * - $this->crud->route = config('lecuong.base.route_prefix')."/article"
     *
     * @return [string]
     */
